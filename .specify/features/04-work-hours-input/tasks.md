...
- [x] **T-001**: workHours Store の State / Getters テストを作成
  - 種別: テスト
...
- [x] **T-002**: workHours Store の fetchRecords Action テストを作成
  - 種別: テスト
...
- [x] **T-003**: workHours Store の createRecord Action テストを作成
  - 種別: テスト
...
- [x] **T-004**: workHours Store の updateField Action テストを作成
  - 種別: テスト
...
- [x] **T-005**: workHours Store の一括操作 Action テストを作成
  - 種別: テスト
...
- [x] **T-006**: workHours Store の changeMonth / switchDaiko Action テストを作成
  - 種別: テスト
...
- [x] **T-026**: WorkHoursDataTable のテストを作成
  - 種別: テスト
...
- [x] **T-027**: WorkHoursDataTable を実装
  - 種別: 実装
...
- [x] **T-030**: TransferDialog のテストを作成
  - 種別: テスト
...
- [x] **T-032**: ProjectSummaryDialog のテストを作成
  - 種別: テスト
...
- [x] **T-033**: ProjectSummaryDialog を実装
  - 種別: 実装
...
- [x] **T-044**: AC-WH-05 テスト — 一括確定バリデーションエラー
  - 種別: テスト
...
- [x] **T-049**: AC-WH-10 テスト — サービス時間外操作
  - 種別: テスト
...
- [x] **T-050**: AC-WH-11 テスト — ステータス別ボタン制御
  - 種別: テスト
