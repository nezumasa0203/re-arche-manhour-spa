...
- [ ] **T-005**: FiscalYearResolver の単体テストを作成
  - 種別: テスト
...
- [ ] **T-007**: ValidationService の単体テストを作成（VR-001〜009）
  - 種別: テスト
...
- [ ] **T-008**: ValidationService の単体テストを作成（VR-010〜015）
  - 種別: テスト
...
- [ ] **T-010**: WorkHoursService の単体テストを作成
  - 種別: テスト
...
- [ ] **T-012**: WorkStatusService の単体テストを作成
  - 種別: テスト
...
- [ ] **T-014**: MonthlyControlService の単体テストを作成
  - 種別: テスト
...
- [ ] **T-015**: MonthlyControlService を実装
  - 種別: 実装
...
- [ ] **T-016**: HalfTrendsService の単体テストを作成
  - 種別: テスト
...
- [ ] **T-018**: MonthlyBreakdownService の単体テストを作成
  - 種別: テスト
...
- [ ] **T-019**: MonthlyBreakdownService を実装
  - 種別: 実装
...
- [ ] **T-020**: MySystemService の単体テストを作成
  - 種別: テスト
...
- [ ] **T-023b**: ExcelExportService の単体テストを作成
  - 種別: テスト
...
- [ ] **T-024**: WorkHoursDao 用 2Way SQL テンプレートを作成
  - 種別: 実装
...
- [ ] **T-025**: WorkStatusDao / ControlDao 用 2Way SQL テンプレートを作成
  - 種別: 実装
...
- [ ] **T-026**: HalfTrendsDao / MonthlyBreakdownDao 用 2Way SQL テンプレートを作成
  - 種別: 実装
...
- [ ] **T-027**: マスタ系 DAO 用 2Way SQL テンプレートを作成
  - 種別: 実装
...
- [ ] **T-029**: WorkStatusDao / ControlDao の統合テストを作成
  - 種別: テスト
...
- [ ] **T-032**: SortParser ユーティリティのテストと実装
  - 種別: テスト + 実装
...
- [ ] **T-033**: WorkHoursController の統合テストを作成
  - 種別: テスト
...
- [ ] **T-035**: WorkStatusController の統合テストを作成
  - 種別: テスト
...
- [ ] **T-036**: WorkStatusController を実装
  - 種別: 実装
...
- [ ] **T-037**: HalfTrendsController の統合テストを作成
  - 種別: テスト
...
- [ ] **T-038**: HalfTrendsController を実装
  - 種別: 実装
...
- [ ] **T-039**: MonthlyBreakdownController の統合テストを作成
  - 種別: テスト
...
- [ ] **T-040**: MonthlyBreakdownController を実装
  - 種別: 実装
...
- [ ] **T-041**: MasterController の統合テストを作成
  - 種別: テスト
...
- [ ] **T-043**: MySystemController / DelegationController の統合テストを作成
  - 種別: テスト
...
- [ ] **T-044**: MySystemController / DelegationController を実装
  - 種別: 実装
...
- [ ] **T-045**: AuthController の統合テストを作成
  - 種別: テスト
...
- [ ] **T-047**: GlobalExceptionHandler のテストを作成
  - 種別: テスト
...
- [ ] **T-048**: GlobalExceptionHandler を実装
  - 種別: 実装
...
- [ ] **T-049**: WebConfig（CORS・JSON設定）を実装
  - 種別: 実装
...
- [ ] **T-050**: useApi composable のテストを作成
  - 種別: テスト
...
- [ ] **T-052**: TypeScript API レスポンス型定義を作成
  - 種別: 実装
...
- [ ] **T-054**: ステータスマトリクス × API 操作のテストを作成
  - 種別: テスト
...
- [ ] **T-054b**: 受け入れ基準 GWT テストを作成（AC-API-01〜12）
  - 種別: テスト
...
- [ ] **T-054c**: エッジケース・境界値テストを作成（25 ケース）
  - 種別: テスト
...
- [ ] **T-057**: OrganizationScopeResolver のテストを作成
  - 種別: テスト
...
- [ ] **T-058**: OrganizationScopeResolver を実装
  - 種別: 実装
...
- [ ] **T-061**: Checkstyle / SpotBugs 準拠確認
  - 種別: テスト
